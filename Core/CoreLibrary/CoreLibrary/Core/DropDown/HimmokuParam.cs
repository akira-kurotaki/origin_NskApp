namespace CoreLibrary.Core.DropDown
{
    ...
    public class HimmokuParam
    {
        ...
        /// </summary>
        public HimmokuParam(string detailModelName, string todofukenCd, string kumiaitoCd, string shishoCd)
        {
        ...
        /// </summary>
        public HimmokuParam(string detailModelName, string todofukenCd, string kumiaitoCd, string shishoCd, 
                            string himmokuOnchangeFunc, string shuruiOnchangeFunc)
        {
            DetailModelName = detailModelName;
            TodofukenCd = todofukenCd;
            KumiaitoCd = kumiaitoCd;
