...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class HalfWidthAlphaNumAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// コントラクター
        /// </summary>
        public HalfWidthAlphaNumAttribute()
        {
            ErrorMessage = SystemMessageUtil.Get("ME00007");
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            // 「a-zA-Z0-9」を半角英数とする
            return StringUtil.IsHalfWidthAlphaNum(value.ToString());
        }
        ...
        //    {
        //        ValidationType = "halfwidthalphanum",
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-halfwidthalphanum", errorMessage);
        }
