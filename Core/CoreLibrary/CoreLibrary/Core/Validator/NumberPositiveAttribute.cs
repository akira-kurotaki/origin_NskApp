...
namespace CoreLibrary.Core.Validator
{
    ...
    /// </remarks>
    public class NumberPositiveAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// 整数の最大桁数
        /// </summary>
        ...
        public NumberPositiveAttribute(int intMaxLength)
        {
            this.MaxLength = intMaxLength;
            ErrorMessage = SystemMessageUtil.Get("ME00069");
        }
        ...
        {
            return NumberUtil.IsNumberPositive(value, MaxLength);
        }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-numberpositive", errorMessage);
            MergeAttribute(context.Attributes, "data-val-numberpositive-intmaxlength", MaxLength.ToString());
        }
