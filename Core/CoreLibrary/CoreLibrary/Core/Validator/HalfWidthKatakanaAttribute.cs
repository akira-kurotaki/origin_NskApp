...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class HalfWidthKatakanaAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// コントラクター
        /// </summary>
        public HalfWidthKatakanaAttribute()
        {
            ErrorMessage = SystemMessageUtil.Get("ME00011");
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            // 「･」～「ﾟ」までを半角カタカナとする
            return StringUtil.IsHalfWidthKatakana(value.ToString());
        }
        ...
        //    {
        //        ValidationType = "halfwidthkatakana",
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-halfwidthkatakana", errorMessage);
        }
