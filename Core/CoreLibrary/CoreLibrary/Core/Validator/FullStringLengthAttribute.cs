...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class FullStringLengthAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// 全桁数
        /// </summary>
        ...
        public FullStringLengthAttribute(int fullLength)
        {
            this.FullLength = fullLength;
            ErrorMessage = SystemMessageUtil.Get("ME00015");
        }
        ...
        //    {
        //        ValidationType = "fullstringlength",
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-fullstringlength", errorMessage);
            MergeAttribute(context.Attributes, "data-val-fullstringlength-length", FullLength.ToString());
        }
