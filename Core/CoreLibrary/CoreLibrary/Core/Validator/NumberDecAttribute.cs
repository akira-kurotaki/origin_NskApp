...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class NumberDecAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// 最大桁数
        /// </summary>
        ...
        {
            return NumberUtil.IsNumberDec(value, IntMaxLength, DecMaxLength);
        }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-numberdec", errorMessage);
            MergeAttribute(context.Attributes, "data-val-numberdec-intmaxlength", IntMaxLength.ToString());
            MergeAttribute(context.Attributes, "data-val-numberdec-decmaxlength", DecMaxLength.ToString());
        }
