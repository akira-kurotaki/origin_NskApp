...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class HiraganaAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// コントラクター
        /// </summary>
        public HiraganaAttribute()
        {
            ErrorMessage = SystemMessageUtil.Get("ME00009");
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            // 「ぁ」～「ゟ(より)」までと、
            // 「ー」をひらがなとする
            return StringUtil.IsHiragana(value.ToString());
        }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-hiragana", errorMessage);
        }
