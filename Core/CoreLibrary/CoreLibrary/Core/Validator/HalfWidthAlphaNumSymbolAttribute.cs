...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class HalfWidthAlphaNumSymbolAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// コントラクター
        /// </summary>
        public HalfWidthAlphaNumSymbolAttribute()
        {
            ErrorMessage = SystemMessageUtil.Get("ME00008");
        }
        ...
        public override bool IsValid(object value)
        {
            ...
            // 「" "（半角スペース）」～「~」を半角英数記号とする
            return StringUtil.IsHalfWidthAlphaNumSymbol(value.ToString());
        }
        ...
        //    {
        //        ValidationType = "halfwidthalphanumsymbol",
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-halfwidthalphanumsymbol", errorMessage);
        }
