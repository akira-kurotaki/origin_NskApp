...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：KAN RI
    /// </remarks>
    public class NumericAttribute : ValidationAttribute, IClientModelValidator
    {
        /// <summary>
        /// コントラクター
        /// </summary>
        ...
        {
            ErrorMessage = SystemMessageUtil.Get("ME00003");
        }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-numeric", errorMessage);
        }
