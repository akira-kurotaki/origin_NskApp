...
namespace CoreLibrary.Core.Validator
{
    ...
    /// 作成者：Rou I
    /// </remarks>
    public class DateYMDAttribute : ValidationAttribute, IClientModelValidator
    {

        /// <summary>
        /// コントラクター
        /// </summary>
        public DateYMDAttribute()
        {
            ErrorMessage = SystemMessageUtil.Get("ME00019");
        }
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-dateymd", errorMessage);
        }
