using BAS_B0000_ManagementService.Common;
using CoreLibrary.Core.Utility;
using System.Diagnostics;

namespace BAS_B0000_ManagementService
{
    /// <summary>
    /// バッチ実行管理プログラム
    /// </summary>
    public class B0000ManagementService : BackgroundService
    {
        /// <summary>
        /// ロガー
        /// </summary>
        private readonly ILogger<B0000ManagementService> _logger;
        ...
        public B0000ManagementService(ILogger<B0000ManagementService> logger)
        {
            _logger = logger;
        }
