using NSK_B000000_Management.Common;
...
namespace NSK_B000000_Management
{
    /// <summary>
    /// 巡回プログラム
    /// </summary>
    class Program
    {
        ...
        // timer_maxcount=0:タイマーを止めない、>0：設定数実行したらタイマーを止める
        private static int timer_maxcount = int.Parse(ConfigUtil.Get(Constants.BATCH_TIMER_COUNT_MAX));
        // $$$$$$$$$$$$$$$$$$$$$$$
