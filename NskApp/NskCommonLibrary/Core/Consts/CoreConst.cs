...
namespace NskCommonLibrary.Core.Consts
{
    ...
    public class CoreConst
    {
        ...
        public static class SystemKbn
        {
            ...
            public const string KyotuKtk = "51";
            [Description("園芸施設共済（共通申請）")]
            public const string KyotuEng = "52";
            [Description("農作物共済（共通申請連携）")]
            public const string KyotuRenkeiNsk = "53";
            [Description("畑作物共済（共通申請連携）")]
            public const string KyotuRenkeiHat = "54";
            [Description("果樹共済（共通申請連携）")]
            public const string KyotuRenkeiKju = "55";
