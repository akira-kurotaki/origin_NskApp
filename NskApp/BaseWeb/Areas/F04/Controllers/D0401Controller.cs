...
using BaseWeb.Areas.F04.Consts;
using BaseWeb.Areas.F04.Models.D0401;
...
namespace BaseWeb.Areas.F04.Controllers
{
    /// <summary>
    /// ファイル取込
    /// </summary>
    ...
    public class D0401Controller : CoreController
    {
        ...
        public ActionResult Init()
        {
            ...
            // 取込対象リスト
            model.MTorikomiList = getJigyoDb<BaseAppContext>().MTorikomis.ToList();
        ...
        private int GetSearchResultCount()
        {
            ...
            return getJigyoDb<BaseAppContext>().Database.SqlQueryRaw<int>(sql.ToString(), parameters.ToArray()).Single();
        }
        #endregion
        ...
        private List<D0401TableRecord> GetResult(D0401Model model, int offset = 0, int pageSize = 10)
        {
            ...
            return getJigyoDb<BaseAppContext>().Database.SqlQueryRaw<D0401TableRecord>(sql.ToString(), parameters.ToArray()).ToList();
        }
        #endregion
        ...
        private D0401TableRecord GetTorikomiManage(string batch_id)
        {
            ...
            return getJigyoDb<BaseAppContext>().Database.SqlQueryRaw<D0401TableRecord>(sql.ToString(), parameters.ToArray()).SingleOrDefault();
        }
        #endregion
        ...
        public ActionResult Import([Bind("TorikomiCd, TodofukenDropDownList, FilePath, PageToken")] D0401Model form)
        {
            ...
            var torikomiNm = getJigyoDb<BaseAppContext>().MTorikomis.Where(m => m.TorikomiCd == form.TorikomiCd).Select(m => m.TorikomiNm).Single();
            Syokuin syokuin = Syokuin;
        ...
        {
            Syokuin syokuin = Syokuin;
            var db = getJigyoDb<BaseAppContext>();
