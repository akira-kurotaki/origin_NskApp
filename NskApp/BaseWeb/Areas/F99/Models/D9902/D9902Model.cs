...
namespace BaseWeb.Areas.F99.Models.D9902
{
    ...
    /// </summary>
    [Serializable]
    public class D9902Model : CoreViewModel
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        ...
        public D9902Model(Syokuin syokuin, List<Shisho> shishoList)
        {
            // 都道府県マルチドロップダウンリスト
            TodofukenDropDownList = new TodofukenDropDownList("", syokuin, shishoList);

            // データロック
            DataLocks = new D9902DataLocks();

            // システムロック
            SysLocks = new D9902SysLocks();
        }
        ...
        /// データロック
        /// </summary>
        public D9902DataLocks DataLocks { get; set; }

        /// <summary>
        /// システムロック
        /// </summary>
        public D9902SysLocks SysLocks { get; set; }
    }
}
